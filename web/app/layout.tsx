...
export const metadata: Metadata = {
  ...
  openGraph: { title: "味藏 WEICANG｜中国新地方主义生活方式品牌", description: "WEICANG — New Localism from China.", url: siteConfig.domain, siteName: "味藏 WEICANG", locale: "zh_CN", type: "website", images: [{ url: "/opengraph-image", width: 1200, height: 630 }] },
  twitter: { card: "summary_large_image", title: "味藏 WEICANG", description: "New Localism from China." },
};
