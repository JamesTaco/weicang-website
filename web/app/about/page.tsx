...
export default function About() { const codes=[["真","REAL"],["轻","LIGHT"],["新","NEW"],["共","TOGETHER"],["远","WORLD"]]; return <>
  ...
  <section className="team"><SectionIntro index="05" label="TEAM" title="扎在地方，也连接世界。" /><div className="team-grid"><article><p>01</p><h3>沈广垣</h3><span>Founder / CEO</span><p>扎根贵州本地执行，负责内容、供应链、渠道、原产地与项目运营，把地方真实资源组织为可以持续发生的产品和关系。</p></article><article><p>02</p><h3>岑荣康 James Cen</h3><span>Co-founder / CTO</span><p>负责 AI、产品战略、品牌与全球化，将技术能力放在幕后，支持产品研究、内容、跨境验证与长期生态建设。</p></article></div><Photo src="/assets/photos/local-maker.jpg" alt="地方生活与风味的创造者" /></section>
  <ContactCTA />
  </>; }
